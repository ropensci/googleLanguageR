...
The API returns a list of two data.frame tibbles - `transcript` and `words`.

Access them via the return object and `$transcript` and `$words`

```r
gl_speech(test_audio, languageCode = "en-GB")
...
> str(result)
#List of 2
# $ transcript:Classes ‘tbl_df’, ‘tbl’ and 'data.frame':	1 obs. of  2 variables:
#  ..$ transcript: chr "to administer medicine to animals is frequently a very difficult matter and yet sometimes it's necessary #to do so"
#  ..$ confidence: chr "0.9711006"
# $ timings   :'data.frame':	19 obs. of  3 variables:
#  ..$ startTime: chr [1:19] "0s" "0.100s" "0.700s" "0.700s" ...
#  ..$ endTime  : chr [1:19] "0.100s" "0.700s" "0.700s" "1.200s" ...
#  ..$ word     : chr [1:19] "to" "administer" "medicine" "to" ...
